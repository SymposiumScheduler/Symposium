...
public class Main {
    ...
    public static void evolutionary(String inputFilePath){
        ...
        System.out.println("Scale for Panelist = " + optimaladjust[0][4]);
        ...
        System.out.println("Scale for Panelist = " + optimaladjust[1][4]);
        System.out.println("Scale for Panelists = " + optimaladjust[0][4]);
        ...
        System.out.println("Scale for Panelist = " + optimaladjust[2][4]);
        System.out.println("Scale for Panelists = " + optimaladjust[0][4]);
    }
