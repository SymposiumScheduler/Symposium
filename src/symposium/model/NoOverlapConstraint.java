...
/**
 * The class NoOverlapConstraint, is an abstract which inherits from Constraints, @see Constraint for documentation.
 ...
 * Constraint is violated when two panels are scheduled at same time and have an overlap of a certain constraint.
 */
