...
public interface Range extends Comparable<Range>, Iterable<TimeRange> {
     ...
     * @return the earliest point in the range.
     */
    int getStart();
     ...
     * @return the latest point in the range
     */
    int getEnd();
     ...
     * @return New range with result, null if there is no intersection.
     */
     ...
     * @return New range with the result.
     ...
     * @return true if they intersect in at least one point, false otherwise
     */
