 ...
 * Constraint is violated when the checked time doesn't satisfy the wanted time
 */
abstract class TimeConstraint extends Constraint {
     ...
     *
     * The method tests whether checkTime is violated or not.
     ...
     * The method tests if the venueTime violates the constraints; it depends on the constraints.
