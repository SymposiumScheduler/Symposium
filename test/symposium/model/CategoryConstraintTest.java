...
public class CategoryConstraintTest {
    ...
    @Test
    public void test_isConstraintViolated_scheduled_false() {
    ...
    public void test_isConstraintViolated_predictive_true(){
        ...
        ScheduleData.instance().assignPanelToVenueTime(ScheduleData.instance().getFreePanels().get(1), ScheduleData.instance().VENUES.get(1).getFreeVenueTimes().get(0));
        ...
        assertTrue(cc1.isConstraintViolated(ScheduleData.instance().VENUES.get(0).getFreeVenueTimes().get(0)));
    ...
    public void test_isConstraintViolated_predictive_false() {
        ...
        assertFalse(cc2.isConstraintViolated(ScheduleData.instance().VENUES.get(1).getFreeVenueTimes().get(0)));
    }
