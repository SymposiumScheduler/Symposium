...
public class MinPanelistConstraintTest {
    ...
    public void testConstructor() throws Exception {
        ...
        Constraint vC = new MinPanelistConstraint(priority, p);
    ...
    public void test_isConstraintViolated_true() throws Exception {
        ...
        MinPanelistConstraint mPC1 = null;
        MinPanelistConstraint mPC2 = null;
        MinPanelistConstraint mPC3 = null;

        for (Constraint c : ScheduleData.instance().getAssignedPanels().get(0).CONSTRAINTS) {
            if (c instanceof MinPanelistConstraint) {
                mPC1 = (MinPanelistConstraint) c;
                break;
            }
        }
    ...
    public void test_isConstraintViolated_truePredictive() {
        ...
        MinPanelistConstraint mPC = new MinPanelistConstraint(ConstraintPriority.REQUIRED, p3);

        assertTrue(mPC.isConstraintViolated(ScheduleData.instance().VENUES.get(0).getFreeVenueTimes().get(0)));
    }
