...
public class SizeConstraintTest {
    ...
    public void test_isConstraintViolated_scheduled_true() {
        ...
        Venue v1 = new Venue("North Building", 1, 2, vt1);

        Venue v2 = new Venue("South Building", 1, 2, vt1);
    ...
    public void test_isConstraintViolated_scheduled_false() {
        ...
        Venue v2 = new Venue("South Building", 2, 2, vt2);
    ...
    public void test_isConstraintViolated_predictive_true() {
        ...
        assertTrue(sc2.isConstraintViolated(ScheduleData.instance().VENUES.get(1).getFreeVenueTimes().get(0)));
    }
    ...
    public void test_isConstraintViolated_predictive_false() {
        ...
        assertFalse(sc2.isConstraintViolated(ScheduleData.instance().VENUES.get(1).getFreeVenueTimes().get(0)));
    }
